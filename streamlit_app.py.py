...
"""
AI-Drone — Flight Range & Airspace Overlay
...
if clicked:
    ...
    if is_in_forbidden(lat, lon):
        ...
        <div style="
            ...
            padding:12px 15px;
            border-radius:10px;
            background:#f3e8ff; /* 옅은 보라색 배경 */
            color:#1f2937;      /* 전체 기본 글자 검정 */
            font-size:14px;
            line-height:1.5;
        ">
...
legend_html = """
<div style="margin-top:8px; padding:14px 16px; border:1px solid #e5e7eb; border-radius:12px;
            background:#ffffff; color:#1f2937; font-size:14px; max-width:1100px; line-height:1.55;">
  ...
  <b style="font-size:15px;"> AI-Drone Flight Distance Optimization <br></b>
  <br>
...
st.components.v1.html(legend_html, height=1000)